    ...
    <div id="project-images">
        ...
        ?>
            <div class="project-image-container">
                <img class="project-image" onclick="openModal(this)" src="/<?= getenv('BASE_URL_DIRECTORY') . 'static/images/projects/' . $project_image['image_filename'] ?>" alt="<?= $project_image['image_alt_text'] ?>">
