...
VALUES
    ('automated-plant-watering','Automated Plant Watering System','Automates plant watering with a micro-controller, sensors, and actuators.','Project overview of the Automated Plant Watering System, an C++ program on an Arduino-compatible board that monitors and waters a plant.','plant_watering_system.jpg','image',5)
   ,('inspirational-website-2','Inspirational Website 2.0','An inspirational website with a daily quote and astronomy image, and a to-do list. Made with Node.js and React.','Project overview of Inspirational Website 2.0, a web app with a to-do list and a new quote and astronomy image every day.','inspirational_website_preview','video',4)
   ...
   ,('tab2xml','TAB2XML','Converts text-based music tablature to playable sheet music. Made in a group project at York University using Java.','Project overview of TAB2XML, a Java GUI that converts text-based tablature to sheet music with audio playing capabilities.','tab2xml_preview','video',3)
